---
title: "Issue auto-triage: duplicate detection and auto-labeling"
area: issue-intake
summary: How new issues are automatically checked for duplicates and labeled from the repo's label set.
...
`claude-code-action` — is in this doc's "Bindings this process needs per
repo" table.
